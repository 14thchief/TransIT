...
const ForgotPassword = () => {
    ...
    const onSubmit = (data: FieldValues) => {
        ...
        sendResetLink((data as SigninPayload).email)
        .unwrap()
        .then(()=> {
            dispatch(openActionModal({
                ...
                isOpen: true,
                type: "success",
                content: "A password reset link has been sent to your email. Click the link to reset your password",
    ...
    return (
        <div className={styles.container}>
            <div className={styles.heading}>
                ...
                <p>
                    Kindly enter email address to reset your password. 
